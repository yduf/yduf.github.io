...
> The original “Skia” was the development name for [QuickDraw GX](https://en.wikipedia.org/wiki/QuickDraw_GX).  This Skia—which, again, doesn’t share code with either of its predecessors—is a kind of version 3, with a tribute name back to that original Skia. - [HN](https://news.ycombinator.com/item?id=16146869) / [wikipedia](https://en.wikipedia.org/wiki/Skia_Graphics_Engine)
