...
### Use firewall rules
Using [UFW](https://blog.stephane-robert.info/docs/securiser/reseaux/ufw/) (default on Linux Mint)

{% highlight bash %}
$ sudo ufw allow in on enp0s8 to 192.168.50.10 port 2049 proto tcp
