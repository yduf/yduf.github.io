...
GitButler lets you work on several branches at the same time, committing and stashing them independently and simultaneously. This ability to do multiple dependant or independent branches at the same time is something that is not possible with vanilla Git.
- [Jujutsu vs GitButler comparison](https://chatgpt.com/share/68f7f700-8cac-800d-88a9-a8ae4267225a)

There is an app and a [`but`tui](https://www.youtube.com/watch?v=zFO210G5m7s).

see
- [ GitButler Product Demo Overview (Summer 2025) ](https://www.youtube.com/watch?v=DhJtNNhCNLM)
...
# [.gitignore ⮺](https://nelson.cloud/.gitignore-isnt-the-only-way-to-ignore-files-in-git/)

[HN](https://news.ycombinator.com/item?id=48583356)
- `.gitignore`
- `.git/info/exclude`
- `~/.config/git/ignore`
- `.gitattributes` - This file lets you specify that git should "ignore" the diff from certain files. 
...
- [Git pull options](https://chatgpt.com/share/6a63d56f-4d14-83eb-b84c-26f663f739d3)