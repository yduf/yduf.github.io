...
title: Zobrist Hash
---
> Zobrist Hashing, a technique to transform a board position of arbitrary size into a number of a set length, with an equal distribution over all possible numbers. - [Zobrist Hashing (chessprogramming.org)](https://www.chessprogramming.org/Zobrist_Hashing) 
