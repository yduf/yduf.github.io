...
- [quick pres](https://www.youtube.com/watch?v=cu9mK7seHT4) (vs Fusion360)
    ...
    - [creer un lien dans un fichier vers une piece d'un autre ficheir](https://wiki.freecad.org/Std_LinkMake/en) - select part in tree, go to main view on target document, click link
