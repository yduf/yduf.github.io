...
toc: true
---
> Your own 3D parametric modeler - [Home](https://www.freecadweb.org/) / [weekly](https://github.com/FreeCAD/FreeCAD/releases) / [github](https://github.com/yduf/FreeCAD?tab=readme-ov-file#your-own-3d-parametric-modeler) / [FreeCAD 1.1 is released!](https://www.youtube.com/watch?v=a9biWv_M8p8)


<link rel="shortcut icon" href="https://www.freecad.org/images/favicon.ico" type="image/x-icon" />

- [ FreeCAD 1.1 is Finally HERE — It’s a GAME CHANGER ! (Major Updates you missed) ](https://www.youtube.com/watch?v=bYdobpjTypg)
- [30 Reasons to use FreeCAD in 2026](https://www.youtube.com/watch?v=3JweHyvE_m8) 
...
- [link tool](https://youtu.be/Y1cifndxxkY?t=431) - very similar to clone, but they are treated as the same body in the model (same color by ex).
	- [Variant Links Made Simple (Tracking vs Enabled)](https://www.youtube.com/watch?v=MoPJD_Fs59g)
...
The Sketcher workbench [features "constraints"](https://www.youtube.com/watch?v=-9KATZg1PqM), allowing 2D shapes to follow precise geometrical definitions in terms of length, angles, and relationships (horizontality, verticality, perpendicularity, etc.). A constraint solver calculates the constrained-extent of 2D geometry and allows interactive exploration of degrees-of-freedom, this can be used for mechanical simulation[^1].

[^1]: [FreeCAD Sketcher is more than just a 2D Sketching Tool \| Explore & Test Mechanical Simulations](https://www.youtube.com/watch?v=bRa-5YJnKCI)
...
- [Sharing Sketch](https://forum.freecad.org/viewtopic.php?style=3&t=56021) - multiples options
    ...
    - bind feature
- [Virtual Sketch](https://www.youtube.com/watch?v=itvoUN4W_EQ&t=108s)- hide/show contraint to have more readable sketch 

## Sheet Metal Workbench
see [Sheet metal ]({% post_url 2025-07-11-sheet-metal %}#freecad)
...
# [Compound Filters ⮺](https://www.youtube.com/watch?v=WOmD8aJk_MI)

Easily see through your model
- generate slice
- generate profile
