...
The Sketcher Workbench is used to create 2D geometries intended for use in the Workbench PartDesign.svg PartDesign Workbench

### [Assembly3 Workbench](https://github.com/realthunder/FreeCAD_assembly3)
This assembly workbench use the constraint library from [solvespace](https://github.com/realthunder/FreeCAD_assembly3/wiki/Build-Instruction#solvespace) and integrate it into freecad.
