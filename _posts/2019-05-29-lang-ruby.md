...
toc: true
---
> [Ruby 4.0.0 Released](https://www.ruby-lang.org/en/news/2025/12/25/ruby-4-0-0-released/) / [The Ruby Toolbox](https://www.ruby-toolbox.com/)  / [online](https://try.ruby-lang.org/)

<link rel="shortcut icon" href="https://www.ruby-lang.org/images/header-ruby-logo.png" type="image/x-icon" />

- [Ruby 3.4.0](https://news.ycombinator.com/item?id=42507312) / [highlights](https://blog.sinjakli.co.uk/2025/01/01/ruby-3-4-highlights/)
...
- [Spinel -- Ruby AOT Compiler](https://github.com/matz/spinel#spinel----ruby-aot-compiler) / [HN](https://news.ycombinator.com/item?id=47887334) - compile ruby to native (by transpilling in C)
  - many restriction (same as mruby) / can it run any gems?
- 
# Lang 
- [Rubysyn](https://github.com/squadette/rubysyn/blob/master/README.md#rubysyn-clarifying-rubys-syntax-and-semantics) - clarifying Ruby's syntax and semantics
...
- [Lowtype](https://news.ycombinator.com/item?id=46080307) - Any type system for Ruby objects that isn’t based on message/method response signature (i.e eigenclass), but instead relies on module ancestors (or worse, class), is fundamentally misaligned with the architecture of the language.

**see also**
- [Lisp’s Influence on Ruby](https://blog.tacoda.dev/lisps-influence-on-ruby-6a54f1a7740e?gi=04cd666cb61b)
...
- [Perl's decline was cultural](https://news.ycombinator.com/item?id=46175112)
...
- [Bundler]({% post_url 2025-01-27-ruby-bundler %}) - lock your dependancies
...
## [Rbenv ⮺](https://linuxize.com/post/how-to-install-ruby-on-ubuntu-20-04/#installing-ruby-using-rbenv)

RBenv does things on the fly by using shims to execute commands. - [example](https://linuxize.com/post/how-to-install-ruby-on-ubuntu-20-04/#installing-ruby-using-rbenv) /² [Ruby Environment](https://github.com/rbenv/rbenv) 
...
Using ubuntu is the safest (nix package is incomplete)
{% highlight bash %}
$ sudo apt install rbenv

$ rbenv init            # Set up rbenv in your shell.
$ source ~/.bashrc      # or relaunch shell
...
## Others
- [**Mise**](https://mise.jdx.dev/lang/ruby.html) / [chatGPT](https://chatgpt.com/c/6960c3fd-5518-8327-8170-425f5fb3fa25) / [HN](https://news.ycombinator.com/item?id=46459564) - is a modern, all-in-one toolchain/version manager, while rbenv is a focused, Ruby-only version manager. 
