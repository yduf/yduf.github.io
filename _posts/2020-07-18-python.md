...
>
>But even so, I must recognise how awful the experience is for new users. <!--more-->
> It's taken me years to settle into this system, and it can take half a day to get someone up to speed with these tools if they haven't used them. - [HN](https://news.ycombinator.com/item?id=37250807) / [Interview with a Senior Python Developer](https://www.youtube.com/watch?v=BgxklT94W0I)
...
uv can use [`pyproject.toml`](https://github.com/yduf/CUDA-Marker/blob/master/pyproject.toml) files to describe package to install. 

[Should I Commit uv.lock or not?](https://chatgpt.com/share/69eb1921-b5f8-83eb-9fc7-cb1d0446bdab)
