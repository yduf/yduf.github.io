...
Other take away:
- qsort is good for big arrays, terrible for small arrays (so in general rely on other sort for small arrays (see early stopping & [THRESHOLD](https://www.youtube.com/watch?v=FJJTYQYB1JQ&t=432s))
