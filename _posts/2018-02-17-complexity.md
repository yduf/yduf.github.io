...
So $log n$ complexity, means here that the number of steps involved in sorting/splitting n elemetn is of the order of the tree depth, with is k (computed by the log).
