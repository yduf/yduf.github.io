...
**see also**
- [MCP vs. the CLI: a head-to-head evaluation of agent tool integration patterns](https://www.youtube.com/watch?v=CfITzVcUkZA)
  - MCP has more latency, use more turn and use more tokens
