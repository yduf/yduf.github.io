...
---
> If you just go to the [file menu and export](https://wiki.freecad.org/Export_to_STL_or_OBJ), FreeCAD just creates a STL file from the visualisation mesh. <!--more--> The mesh tessellation was earlier simply defined from the FreeCAD PartDesign WB visualisation setting. 
