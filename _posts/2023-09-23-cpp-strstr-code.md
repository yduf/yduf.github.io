...
Nobody has implemented it in the past 30 years, because it's an intrinsic (because it's not possible to have portable code and compare 4bytes at once), but the code below is the optimal version for the bruteforce method in c++. 
