...
---
> beautiful code isn't enough, it has to be safe, beautiful, maintainable, productive, understandable, and resource efficient...  Rust hits more of these but it's ugly. 
> Uglier than Python and approaches C++-level eyebleed. <!--more-->
