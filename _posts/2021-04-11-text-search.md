...
- [	Fast and Easy Levenshtein distance using a Trie (2011)](https://stevehanov.ca/blog/fast-and-easy-levenshtein-distance-using-a-trie) / [HN](https://news.ycombinator.com/item?id=47738673) - If you have a web site with a search function, you will rapidly realize that most mortals are terrible typists. Many searches contain mispelled words, and users will expect these searches to magically work. 
