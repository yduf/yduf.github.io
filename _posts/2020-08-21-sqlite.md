...
_I will write my own database. How hard can that be?_ - [Reliability Lessons From SQLite ](https://www.youtube.com/watch?v=V_qzqY1bb7I) - [Richard Hipp](https://en.wikipedia.org/wiki/D._Richard_Hipp)
<details markdown="1"><summary>summary</summary>
- half of the IO on your phone is SQlite.
- delivered has one big .c file (edition is on splitted version)
- describe test strategy & some of the tools used
  - fuzzing
- plugable interface (test)
  - SQL Functions
  - Collating Functions
  - Virtual Tables
  - Memory Allocator
  - Page Cache
- Published API (used to inject error during testing)
  - sqlite_test_control API
</details>
...
- about [SQLITE_BUSY exception](https://news.ycombinator.com/item?id=42095423)
	- [SQLite concurrency and why you should care about it](https://news.ycombinator.com/item?id=45781298)
