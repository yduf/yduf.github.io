...
{% highlight bash %}
# tuned with
GRUB_CMDLINE_LINUX="mitigations=off splash isolcpus=1 nohz_full=1 rcu_nocbs=1 threadirqs processor.max_cstate=1 idle=poll"
$ sudo update-grub
...
## second
GRUB_CMDLINE_LINUX="mitigations=off quiet splash isolcpus=1 nohz_full=1 rcu_nocbs=1 irqaffinity=0 threadirqs processor.max_cstate=1 idle=poll tsc=nowatchdog nosoftlockup acpi_irq_nobalance elevator=none"
