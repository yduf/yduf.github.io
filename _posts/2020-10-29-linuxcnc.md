...
- [**WHB04B-6 CNC controller**]({% post_url 2022-04-18-cnc-whb04b-6-controller %})
...
- [ ] - have a working Keyboard - logitech doesn't anymore
	- [ ] - [Using the Windows key to open Xfce application menu](https://www.clausconrad.com/
...
- auto start `xcape -e 'Super_L=XF86Launch1'`
	- [ ] - navigate virtual desktop with arrow
