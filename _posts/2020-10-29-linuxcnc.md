...
Alternatively see [LinuxCNC on Linux Mint Debian Edition 6 ](https://forum.linuxcnc.org/9-installing-linuxcnc/50226-linuxcnc-on-linux-mint-debian-edition-6)
...
{% endhighlight %}
    ...
    - [ ] make sure `/sys/kernel/realtime` exist (see kernel patch above)
{% highlight bash %}
