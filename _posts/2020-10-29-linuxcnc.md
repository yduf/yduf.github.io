...
- [compile RT kernel](https://toxigon.com/building-a-real-time-linux-kernel) 🚧 
    - `uname -a`
    - `Linux cnc 6.12.0 #1 SMP PREEMPT_RT Sun Apr 27 21:17:13 CEST 2025 x86_64 x86_64 x86_64 GNU/Linux`
    	- this is OK
- compile linux cnc
    - TODO make sure PREEMPT-RT is active / enabled
	
{% highlight bash %}
# make sure user is part of realtime group
$ sudo groupadd realtime              # create realtime group
$ sudo usermod -a -G realtime $USER   # add yourself to groups
...
{% endhighlight %}
	...
	- [is failing the latency test](https://chatgpt.com/share/680fe624-a044-800d-95de-282f92900b33)
- add ui
	- add probe plugin
