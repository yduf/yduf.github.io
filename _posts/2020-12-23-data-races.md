...
---
> Sequential consistency is expensive on most multiprocessors... Fortunately, C++11 lets you relax sequential consistency in a controlled way, which combines high performance with the safety of well-defined (if complex) semantics...<!--more-->
