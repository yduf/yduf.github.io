...
- [Quake in 13 Kilobytes (2021) ](https://news.ycombinator.com/item?id=48693428)
...
# [Code Review](http://fabiensanglard.net/quake3/index.php)

- [ How 1999 Quake 3 Teaches Elite Software Engineering ](https://www.youtube.com/watch?v=NeLkxuzCssA&t=1s) 
	- unique events queue - allows full log and bug reproducibility
	- 3 VMs server gane VM / Client game VM / UI VM
		- game logic cannot crash the engine (use only Engine API exposed in the VM)
	- server Frame / client Frame
	- fuzzy logic / fitness function
	- Geneteic algorithm for bots generation
- [JMP van Waveren  (MrElusive) Thesis (on quake3 bots)](https://www.researchgate.net/publication/240430519_The_Quake_III_Arena_Bot) / [presentation](https://mrelusive.com/publications/presentations/2001_thesis/Q3ABotAI_presentation.pdf?utm_source=chatgpt.com)
