...
tags: raspberry-pi linux-system obsolete
excerpt_separator: <!--more-->
---
> A Raspberry Pi distribution for 3d printers. <!--more--> It includes the OctoPrint host software for 3d printers out of the box and mjpg-streamer with RaspiCam support for live viewing of prints and timelapse video creation. - [OctoPi](https://github.com/guysoft/OctoPi)
