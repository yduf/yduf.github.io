...
There are Debian .deb packages available through community-maintained repositories:
- [debian.griffo.io](https://debian.griffo.io/fr/?utm_source=chatgpt.com) - up to date tools for developpers
- other repos seems unmaintained

{% highlight bash %}
# setup griffo depo (with sudo)
