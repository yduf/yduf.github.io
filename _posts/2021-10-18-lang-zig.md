...
**see also**
- [Why we still use C despite so many C alternatives](https://www.youtube.com/watch?v=eFzkbQq2jJU) - covers:
  - Zig
  - Odin
  - C3

- 2026-05-30 - [Build System Reworked](https://ziglang.org/devlog/2026/#2026-05-26) 
...
Then to run
- work from scracth with [vscode .runner]({% post_url 2018-08-12-vscode %}#dev)
...
Zig does not have RAII in the C++ sense, but it does support deterministic resource management through explicit _defer/errdefer_ and scope-based cleanup - [ChatGPT](https://chatgpt.com/share/6975d02f-3db4-800d-bfa8-b53f58fa0fe6)

## Object

Zig does not have classes or objects in the traditional OOP sense. - [ChatGPT](https://chatgpt.com/share/6975d0b2-6570-800d-8185-a24c77d37eb5)
...
[Zig function](https://chatgpt.com/share/6975e44c-5f3c-800d-8645-b85e846a77d8) can return
- Primitive values
- Composite types
...
Using nix [profile]({% post_url 2026-01-24-package-nix %}#using-profile)
