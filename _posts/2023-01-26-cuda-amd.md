...
**see also**
- [BarraCUDA](https://github.com/Zaneham/BarraCUDA?tab=readme-ov-file#barracuda) / [HN](https://news.ycombinator.com/item?id=47052941) - An open-source CUDA compiler that targets AMD GPUs, with more architectures planned.  
