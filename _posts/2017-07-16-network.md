...
So far setting up a static ip with netplan with NetworkManager, prevent creation of interface for usb/ethernet adatper, unless explictly authorized in net plan config, for eg:
{% highlight bash %}
network:
  ethernets:
    # remarkable
