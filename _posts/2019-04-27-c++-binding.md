...
tags: c++ binding opencv qt crystal ruby dlang
---
...
- [Mirror Bridge](https://github.com/FranciscoThiesen/mirror_bridge#mirror-bridge) - Generate Python, Lua, and JavaScript bindings from C++ **using C++26** reflection. Zero boilerplate, zero runtime overhead, zero binding code.
