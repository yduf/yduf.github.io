...
# [Kubuntu ⮺](https://chatgpt.com/share/6a4a25e9-a8e0-83eb-94e2-505a9038c5bf)

For Kubuntu specifically, the systemd --user + ssh-agent + AddKeysToAgent yes setup is usually the least surprising configuration.