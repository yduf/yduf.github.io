...
---
> After some experience with a small Synology NAS, and experencied the blue led of death (fortunaltely solved), I decided to move to my own hardware supporting [ZFS]({% post_url 2019-03-31-zfs-ubuntu %}) with [Raid 5]({% post_url 2019-01-01-SHR %}). - yves
