...
# lib
- [puff](https://github.com/madler/zlib/blob/develop/contrib/puff/puff.c) - a simple inflate written to be an unambiguous way to specify the deflate format. 
...
- [An ode to bzip](https://news.ycombinator.com/item?id=47377998) - [There was an analysis which argued that zstd is pareto optimal.](https://insanity.industries/post/pareto-optimal-compression/)
  - _Pareto optimality is a situation where no […] preference criterion can be better off without making at least one […] preference criterion worse off […]._