...
tags: emulator wine thread
toc: true
excerpt_separator: <!--more-->
---
> [Wine](https://www.winehq.org/) is a compatibility layer capable of running Windows applications on several POSIX-compliant operating systems, such as Linux, macOS, & BSD. <!--more--> Instead of simulating internal Windows logic like a virtual machine or emulator, Wine translates Windows API calls into POSIX calls on-the-fly, eliminating the performance and memory penalties of other methods and allowing you to cleanly integrate Windows applications into your desktop.

- [Wine 11 rewrites how Linux runs Windows](https://www.xda-developers.com/wine-11-rewrites-linux-runs-windows-games-speed-gains/) / [HN](https://news.ycombinator.com/item?id=47507150) - now use some support directly from linux kernel for thread sync
	- [WHY IT CAN'T BE DONE WITH EXISTING TOOLS](https://lore.kernel.org/lkml/f4cc1a38-1441-62f8-47e4-0c67f5ad1d43@codeweavers.com/T/#u)
...
# [Proton ⮺ ](https://chatgpt.com/share/6aaff423-6bc4-83ed-86ea-746712f3e96e)

<div class="encart blue" markdown="1">
Proton-GE + umu — recommended for games
