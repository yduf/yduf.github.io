...
- [PixiEditor](https://pixieditor.net/) / [HN](https://news.ycombinator.com/item?id=44746583) / [github](https://github.com/PixiEditor/PixiEditor?tab=readme-ov-file#the-only-2d-graphics-editor-youll-ever-need) - Create beautiful sprites for your games, animations, edit images, create logos. All packed up in an intuitive and familiar interface. / [youtube](https://www.youtube.com/watch?v=5hmW2ZKO1YY)
