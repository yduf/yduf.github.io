...
published: true
title: '# SSH'
tags: network ssh shell cli security network-security linux-system tmux
toc: true
excerpt_separator: <!--more-->
---
> Your _private key_ should **never leave a host**. <!--more--> That should be a policy and you should write rules to detect when that policy is being violated (check for processes accessing the file).
> 
> If you need access from N computers you should be generating N keys. - [HN](https://news.ycombinator.com/item?id=26271735)

# [tmux ⮺](https://chatgpt.com/share/69ad6b64-2284-800d-a11d-6f30ce649b2d)

<div class="encart blue" markdown="1">
A common way to keep long-running terminal tasks alive even if your SSH connection drops.
</div>
...
- [dtach](https://chatgpt.com/share/69c7a332-5118-8389-b01a-6081500aa3ac)

## Shortcuts

**detach** - `Ctrl+b` then `d`

[**see also**](https://chatgpt.com/share/69ad6da6-4e68-800d-94ba-3e357e05346b)
- [byobu](https://www.byobu.org/) - A user-friendly wrapper around tmux or screen that adds status bars, notifications, and easier keybindings.

# [Truly convenient SSH](https://sw.kovidgoyal.net/kitty/kittens/ssh/)

using [kitty]({% post_url 2020-10-02-kitty-term %})
...
You might need to start [ssh-agent]({% post_url 2018-08-19-ssh-agent %}) before you run the ssh-add command ([SO](https://stackoverflow.com/questions/17846529/could-not-open-a-connection-to-your-authentication-agent)):
{% highlight bash %}
$ eval `ssh-agent -s`
$ ssh-add ~/.ssh/id_rsa # add keys to agent # if no keys are know
{% endhighlight %}

## [ Enroll public key ⮺](https://askubuntu.com/questions/4830/easiest-way-to-copy-ssh-keys-to-another-machine/4833#4833)
...
Or (eg if retrived by localsend)  
{% highlight bash %}
...
- [mosh]({% post_url 2017-06-04-ssh-mosh %})

http://byobu.co/index.html


## [Generating key ⮺ 🔑](https://docs.github.com/en/free-pro-team@latest/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent)
...
## [Github access]({% post_url 2020-10-16-github %}#connect-to-github-with-ssh)
  
see [Connect to GitHub with SSH]({% post_url 2020-10-16-github %}#connect-to-github-with-ssh)
  
# [SSH-Agent 👮]({% post_url 2018-08-19-ssh-agent %})
  
see [ssh-agent]({% post_url 2018-08-19-ssh-agent %})
...
# TroubleShooting 🛠️
- [ChatGPT](https://chatgpt.com/share/694543f5-7444-800d-b3f1-cab539d373d4)
...
# see also
- [	The Day the Telnet Died ](https://news.ycombinator.com/item?id=46967772)