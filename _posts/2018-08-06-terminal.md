...
- [Termux application](https://github.com/termux/termux-app?tab=readme-ov-file#termux-application) / [HN](https://news.ycombinator.com/item?id=46854642) -  an Android terminal application and Linux environment.
...
- [Why Are Linux I/O Devices Called TTY?](https://www.youtube.com/watch?v=31JBOlrzPXs&t=12s)
