...
- about:processes - [Task Manager - see whether tabs or extensions are slowing down Firefox](https://support.mozilla.org/en-US/kb/task-manager-tabs-or-extensions-are-slowing-firefox) - `SHIFT - ESC`
