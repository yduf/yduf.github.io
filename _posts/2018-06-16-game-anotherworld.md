...
title: Another World
published: true
tags: games vector-graphic code-review zip
---
...
- [[SC] Another World, une belle leçon d'architecture logicielle - Olivier Poncet](https://www.youtube.com/watch?v=OyJScQqUAsA)
	- [**bytekiller**](https://github.com/dimakaju/AmigaBytekiller.NET) - Amiga compression algorithm - codage entropique fixe et non adaptatif - in place compression (un seul buffer)
	- machine virtuelle dédié au jeu
		- defnition des polygones par bandes
