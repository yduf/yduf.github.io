...
_more than 1 MB block sizes are probably overkill in most applications (of per-block linear computation). Most of the processing in our case takes more than 1 cycle per byte, so the 128 kB size is already plenty_

- [	How much linear memory access is enough? ](https://solidean.com/blog/2026/how-much-linear-memory-access-is-enough/) / [HN](https://news.ycombinator.com/item?id=47689793)

[!svg graph](https://solidean.com/blog/2026/how-much-linear-memory-access-is-enough/chart3_kernels_64mb.svg)](https://solidean.com/blog/2026/how-much-linear-memory-access-is-enough/)