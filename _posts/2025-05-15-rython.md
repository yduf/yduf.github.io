...
- [py2rb.py](https://github.com/naitoh/py2rb/blob/master/README.rst) - A code translator using AST from Python to Ruby. This is basically a NodeVisitor with ruby output.
