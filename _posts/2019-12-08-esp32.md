...
They can run linux, and some have mmu ESP32-S31 (mmu)

# see also
- [doodlesoul](https://evandroguedes.github.io/doodlesoul/) - every ESP32 leaves the factory with one hand-drawn character latent in its silicon. this page reads your chip's MAC address and wakes the same soul the firmware would, drawn right in your browser by the same engine compiled to WebAssembly.
