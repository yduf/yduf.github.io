...
---
> It’s inappropriate to use a CRC in place of a general purpose hash function because **CRCs usually have biased output**. <!--more--> It’s equally inappropriate to use a general purpose hash function in place of a CRC because general purpose **hash functions usually do not make any guarantees on the conditions under which hash collisions can occur**. - [CRCs vs Hash Functions](https://eklitzke.org/crcs-vs-hash-functions)
...
**see also**
- [ How Old-School Cassette Tape Drives Played Games | MVG ](https://www.youtube.com/watch?v=cS7SWdTVKys)