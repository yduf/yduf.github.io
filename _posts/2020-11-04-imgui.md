---
title: '# Dear ImGui'
tags: gui imgui lib-c++ image-lib quote blog-code
toc: true
excerpt_separator: <!--more-->
---
> Dear ImGui is a bloat-free graphical user interface library for C++. <!--more--> It outputs optimized vertex buffers that you can render anytime in your 3D-pipeline enabled application. It is fast, portable, renderer agnostic and self-contained (no external dependencies). - [github](https://github.com/ocornut/imgui#dear-imgui) / [demo](https://pthom.github.io/imgui_manual_online/manual/imgui_manual.html) / [2](https://raw.githubusercontent.com/wiki/ocornut/imgui/web/v167/v167-misc.png)
...
- [Ned](https://news.ycombinator.com/item?id=45952824) - ImGui Text Editor with GL Shaders 
