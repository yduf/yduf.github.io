...
**see also**
- [Clx ](https://github.com/samyeyo/clx) / [HN](https://news.ycombinator.com/item?id=48871547) Compile Lua to Native Executables Through C++20

[ Creator of Lua: What People Get Wrong About Scripting Languages ](https://www.youtube.com/watch?v=jCZnFKk6M9A) - [Roberto Ierusalimschy](https://en.wikipedia.org/wiki/Roberto_Ierusalimschy) 
<details markdown="1"><summary>summary</summary>
- Lua is very good at having the main loop writtten in C, and other parts in Lua (extending vs embedding). Lua is good at both.
  - raise an exception in Lua / catch it in C
  - lua doesn't have a global state (you have to create a new state before calling Lua interp).
  - scripting vs dynamic langages (bash vs lua)
  - book about langage design:
    - Java script the good parts
  - lua JIT is a completly different project (make by other people)
    - works well because of the simplicity of Lua
</details>
...
# Lua Langage
## [Install ⮺ 📥 ](https://www.geeksforgeeks.org/how-to-install-and-setup-lua-in-linux/)
{% highlight bash %}
...
## [Operators ⮺](https://lua-users.org/wiki/OperatorsTutorial)

**==** equal to  
**~=** not equal to, _Pico-8 support **!=** as well_  
**<** less than  
**>** greater than  
