...
- [Libretro retro8](https://doc.pixl-os.com/pico-8_libretro-retro8/)
- [Fantasy Console Wiki!](https://fantasyconsoles.org/wiki/Main_Page) / [r/pico8](https://www.reddit.com/r/pico8/comments/1p9lvio/a_great_resource_fantasy_consoles_wiki_with_lots/) - a really handy wiki that gathers a large number of fantasy consoles and fantasy computers in one place
...
- [PICO-8 0.2.7](https://www.lexaloffle.com/bbs/?tid=150992) -  2025-08-16 - [RELEASE OVERVIEW](https://www.youtube.com/watch?v=whcUy97uEVM)
	- `rrect`\[`fill`\] - round rect - defined as (w,h) instead of (x1,y1)
...
- [PICO-8 0.2.2](https://www.lexaloffle.com/bbs/?tid=41544) -  2021-02-15 - [RELEASE OVERVIEW](https://www.youtube.com/watch?v=N7s2KIy3MZQ)
	- [fullscreen editor mode](https://www.youtube.com/watch?v=N7s2KIy3MZQ&t=830s) `Shift+Tab`
	- P8SCII - character data can be specified and printed in-line using "\^." followed by 8 bytes of raw binary data
	- [Custom Fonts](https://www.youtube.com/watch?v=N7s2KIy3MZQ&t=4381s)
	- [Sprite fill pattern](https://www.youtube.com/watch?v=N7s2KIy3MZQ&t=1552s) - `fillp(♥\1|0b.011)`
	- multipoke
	- Custom menu control
    - print return value
