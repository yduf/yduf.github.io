...
toc: true
---
> PipeWire has a better vibe than Pulseaudio did. It intends to replace a system that never worked flawlessly, seems to focus on compatibility, and the apparent endorsement from the [JACK]({% post_url 2017-06-09-linux-audio-jack %})-developers also does not hurt. - [PipeWire Overview](https://docs.pipewire.org/page_overview.html) / [lwn](https://lwn.net/SubscriberLink/847412/d7826b1353e33734/) / [HN](https://news.ycombinator.com/item?id=26329027)

- [PipeWire Guide ](https://github.com/mikeroyal/PipeWire-Guide?tab=readme-ov-file#-----pipewire-guide)

# [Patchbay  ⮺]({% post_url 2024-12-02-audio-patchbay %}) 
