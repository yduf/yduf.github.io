...
[pi 5]({% post_url 2026-06-21-hardware-raspberry-pi5 %}) now has `bin/wake_up tronaut` script
</div>

**see also**
- [How Wake-On-LAN works (2020) ](https://blog.xaner.dev/post/wake-on-lan/and) / [HN](https://news.ycombinator.com/item?id=47729507) 
