...
tags: linux-system power watchdog network systemd automation
toc: true
---
...
## [GUI](https://chatgpt.com/share/69a45f53-71b8-800d-8e3b-091d377b2db7)

### [GWakeOnLan](https://github.com/muflone/gwakeonlan?tab=readme-ov-file#gwakeonlan)

{% highlight bash %}
$ sudo apt install gwakeonlan
{% endhighlight %}

### [Wake-on-LAN](https://extensions.gnome.org/extension/8239/wake-on-lan/) 🚧
- not working
