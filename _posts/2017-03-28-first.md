...
### Folding content
- [using HTML only?](https://stackoverflow.com/a/52491581/51386) / [custom expand](https://dev.to/jordanfinners/creating-a-collapsible-section-with-nothing-but-html-4ip9)
{% highlight ruby %}
{::nomarkdown}
<details>
...
- [install](https://jekyllrb.com/docs/)
	- **Obsolete** [Not compatible with Ruby 3.0](https://github.com/github/pages-gem/issues/752) - use [ruby 2.7]({% post_url 2019-05-29-ruby %}#install-ruby)
