...
title: "Jekyll (first) 🧪"
published: true
tags: jekyll blog web markdown brightness RSS
use_math: true
---
...
**see also**
- [20 Years of Bloggin](https://remysharp.com/2026/06/17/20-years-of-blogging)
...
- alternate hosting on [statichost](https://www.statichost.eu/) / [HN](https://news.ycombinator.com/item?id=49569896) - 100% European
static website hosting
  - [codefloe](https://docs.codefloe.com/pages/) / [HN](https://news.ycombinator.com/item?id=49571580) - offers a free built-in integration with no restriction on personal or private repositories.
...
**see also**
- [Display an array of images](https://talk.jekyllrb.com/t/display-an-array-of-images/3348)
...
**see also**
- [setup CSS for citation](https://chatgpt.com/share/69871eb3-8480-800d-8e75-a65a5c6e8ade)
...
### [text block ⮺](https://chatgpt.com/share/6a6dc1a1-bf38-83eb-8c63-60e167969631)

With wrapping

{% highlight html %}
<div class="text-block">
This is a long piece of text that automatically wraps but still looks similar to a code block.
</div>
{% endhighlight %}
...
**see also** 💭 
- [this site](https://kizu.dev/shrinkwrap-solution/#chained-anchors-abomination) for inspiration
...
### [RSS ⮺](https://chatgpt.com/share/6aa3a5f7-8e2c-83eb-8f04-d3be27c81bda)

Publish on your own site, syndicate elsewhere - [HN](https://news.ycombinator.com/item?id=46468600)

- [Desktop reader ](https://chatgpt.com/share/6aa3a388-c374-83eb-a9e6-ea10e2eb5c6f)
  - [RSS Guard](https://rssguard.com/?utm_source=chatgpt.com) - flathub
    - discover - import selected
...
## Install 📥
- [Install ruby 3.2.0 💎]({% post_url 2019-05-29-lang-ruby %}#rbenv-)
...
$ bundle install
# if it fails 
# rm -rf vendor/bundle .bundle Gemfile.lock.text-block {
  background: #f6f8fa;
  border: 1px solid #d0d7de;
  border-radius: 6px;
  padding: 1em;
