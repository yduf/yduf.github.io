...
tags: hash hamming distance nearest-neighbor vector-db search LLM
excerpt_separator: <!--more-->
---
> Build multiple hash tables on binary code substrings that enables exact K-nearest neighbor search in Hamming space. <!--more--> The algorithm is straightforward to implement,  storage  efficient,  and  it  has  sub-linear  runtime behavior for uniformly distributed codes. - [Fast Search in Hamming Space with Multi-Index Hashing](https://www.cs.toronto.edu/~norouzi/research/papers/multi_index_hashing.pdf) / [SO](https://stackoverflow.com/a/47487949/51386)

see also
- [Hierarchical navigable small world (HNSW)]({% post_url 2026-03-24-algorithm-HNSW %})
