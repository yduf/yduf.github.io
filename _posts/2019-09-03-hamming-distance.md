...
see also
- [Scaling HNSWs](https://news.ycombinator.com/item?id=45887466) - most of Redis is single-threaded, but antirez decided to use threads for the [HNSW](https://en.wikipedia.org/wiki/Hierarchical_navigable_small_world) implementation and explains why.
